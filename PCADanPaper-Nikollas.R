...
P9_iMNTB = as.data.frame((split_by_variable(m_ID,split_col = "ID")$P9_iMNTB))
P4_iMNTB = (split_by_variable(m_ID,split_col = "ID")$P4_iMNTB)
P6_iMNTB = (split_by_variable(m_ID,split_col = "ID")$P6_iMNTB)

P9_TeNT = (split_by_variable(m_ID,split_col = "ID")$P9_TeNT)
P4_TeNT = (split_by_variable(m_ID,split_col = "ID")$P4_TeNT)
P6_TeNT = (split_by_variable(m_ID,split_col = "ID")$P6_TeNT)

P9_data = rbind((split_by_variable(m_ID,split_col = "ID")$P9_iMNTB),(split_by_variable(m_ID,split_col = "ID")$P9_TeNT))
P6_data = rbind((split_by_variable(m_ID,split_col = "ID")$P6_iMNTB),(split_by_variable(m_ID,split_col = "ID")$P6_TeNT))
P4_data = rbind((split_by_variable(m_ID,split_col = "ID")$P4_iMNTB),(split_by_variable(m_ID,split_col = "ID")$P4_TeNT))

P9_iMNTBf = as.data.frame((split_by_variable(m_firing,split_col = "ID")$P9_iMNTB))
P4_iMNTBf = (split_by_variable(m_firing,split_col = "ID")$P4_iMNTB)
P6_iMNTBf = (split_by_variable(m_firing,split_col = "ID")$P6_iMNTB)

P9_TeNTf = (split_by_variable(m_firing,split_col = "ID")$P9_TeNT)
P4_TeNTf = (split_by_variable(m_firing,split_col = "ID")$P4_TeNT)
P6_TeNTf = (split_by_variable(m_firing,split_col = "ID")$P6_TeNT)

P9_dataf = rbind((split_by_variable(m_firing,split_col = "ID")$P9_iMNTB),(split_by_variable(m_firing,split_col = "ID")$P9_TeNT))
P6_dataf = rbind((split_by_variable(m_firing,split_col = "ID")$P6_iMNTB),(split_by_variable(m_firing,split_col = "ID")$P6_TeNT))
P4_dataf = rbind((split_by_variable(m_firing,split_col = "ID")$P4_iMNTB),(split_by_variable(m_firing,split_col = "ID")$P4_TeNT))
...
if(0) {
  ...
  # Create the PCA plot
  p4 = plot_pca_clusters(clusters, df)
}
